...
const routes = [
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            { path: 'wood-types', name: 'admin-wood-types', component: () => import('../pages/admin/WoodTypesPage.vue') },
            { path: 'furniture-types', name: 'admin-furniture-types', component: () => import('../pages/admin/FurnitureTypesPage.vue') },
